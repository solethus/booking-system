// Code generated by the Encore v1.40.4 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-booking-system-oswi.encr.app`
}
...
/**
 * Client is an API client for the booking-system-oswi Encore application. 
 */
...
export namespace booking {
    ...
    export class ServiceClient {
        ...
        public async ListBookings(): Promise<ListBookingResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/booking`)
            return await resp.json() as ListBookingResponse
        }
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "booking-system-oswi-Generated-TS-Client (Encore/v1.40.4)";
        }
