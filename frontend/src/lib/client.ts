// Code generated by the Encore v1.29.6 client generator. DO NOT EDIT.
  ...
  export class ServiceClient {
    ...
    public async GetBookableSlots(_from: string): Promise<SlotsResponse> {
      ...
      const resp = await this.baseClient.callAPI(
        "GET",
        `/slots/${encodeURIComponent(_from)}`,
      );
      return (await resp.json()) as SlotsResponse;
    }

    public async ListBookings(): Promise<ListBookingsResponse> {
      // Now make the actual call to the API
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "booking-system-oswi-Generated-TS-Client (Encore/v1.28.0)",
    };
